...
void GFXVulkanDevice::enterDebugEvent(ColorI color, const char *name)
{
#ifdef TORQUE_BASIC_GPU_PROFILER
...
void GFXVulkanDevice::leaveDebugEvent()
{
#ifdef TORQUE_BASIC_GPU_PROFILER
...
void GFXVulkanDevice::setDebugMarker(ColorI color, const char *name)
{
